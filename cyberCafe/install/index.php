		...
		<div class="container">
			<div class="row">
				<div class="offset-3 col-6">
					<h1 class="text-center">Cyber Cafe Management</h1>
					<div class="tab" role="tabpanel">
						<form class="tab-content tabs" action="<?php  echo $_SERVER['PHP_SELF']; ?>" method="POST">
							<div role="tabpanel" class="tab-pane active" id="Section1">
								<h3>Welcome to Cyber Cafe Management</h3>
								<p>Introducing Gym Management - a complete management solution to manage your daily users, Computers, Reports & etc.</p>
								...
								if(isset($_POST['install'])){
									if(!isset($_POST['host']) || $_POST['host'] == ''){
										...
										if(mysqli_connect_error()){
											...
											copy("install.inc.php","../class/database.php");
											...
											include '../config.php';
											$db = new Database();
											$db->update('admin',array('username'=>$username,'password'=>$password),"id=1");
        									$res1 = $db->getResult();
											header('location:'.$base_url);
										}
									}
